            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('waleed.jpg')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('waleed.jpg')}}" class="user-image" alt="User Image">
                            <span class="hidden-xs">Waleed Abd Elsabour</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                ...
                                <p>
                                    waleed Abd Elsabour - Web Developer
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('admin.product.create')}}"><i class="fa fa-circle-o"></i> Create</a></li>
                       <li><a href="{{route('admin.product.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>Catogeries</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('admin.category.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route('product.index')}}"><i class="fa fa-circle-o"></i> Show</a></li>
                    </ul>
                </li>
            </ul>
        </section>
